...
!Stockage de la valeur max de la colonne du fichier 'init_turb.data' utilisee pour generer la perturbation en densite
  ...
  if(bb_test)then
     ...
     write(*,*)
     !====================================================================
     !FIN DU CALCUL DES PERTURBATIONS, SUITE LIGNE 377
     !====================================================================
     ...
     DO i=1,nn
       ...
       if(Mach .eq. 0)then
             ...
             !ind_i = int((x(i,1)/boxlen)*n_size)+1  !MODIF BY P.HENNEBELLE
             !AND A.VERLIAT ON 14/12/2018 FOR BIGBOX PERTURBATIONS
             !ind_j = int((x(i,2)/boxlen)*n_size)+1
             !ind_k = int((x(i,3)/boxlen)*n_size)+1
     ...
     write(*,*)
     write(*,*) '=============================================================================='
     write(*,*) 'Verification des caracteristiques de densite dans le coeur:'
     write(*,*) 'Valeur de d0 : ', d0
